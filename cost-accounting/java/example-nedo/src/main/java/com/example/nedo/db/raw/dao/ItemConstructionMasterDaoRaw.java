...
import com.example.nedo.db.doma2.entity.ItemConstructionMasterIds;
import com.example.nedo.db.doma2.entity.ItemConstructionMasterKey;
import com.example.nedo.db.raw.CostBenchDbManagerJdbc;

public class ItemConstructionMasterDaoRaw extends RawJdbcDao<ItemConstructionMaster> implements ItemConstructionMasterDao {
    ...
    static {
        ...
        add(list, "ic_parent_i_id", ItemConstructionMaster::setIcParentIId, ItemConstructionMaster::getIcParentIId, RawJdbcUtil::setInt, RawJdbcUtil::getInt, true);
        add(list, "ic_i_id", ItemConstructionMaster::setIcIId, ItemConstructionMaster::getIcIId, RawJdbcUtil::setInt, RawJdbcUtil::getInt, true);
        add(list, "ic_effective_date", ItemConstructionMaster::setIcEffectiveDate, ItemConstructionMaster::getIcEffectiveDate, RawJdbcUtil::setDate, RawJdbcUtil::getDate, true);
        add(list, "ic_expired_date", ItemConstructionMaster::setIcExpiredDate, ItemConstructionMaster::getIcExpiredDate, RawJdbcUtil::setDate, RawJdbcUtil::getDate);
        add(list, "ic_material_unit", ItemConstructionMaster::setIcMaterialUnit, ItemConstructionMaster::getIcMaterialUnit, RawJdbcUtil::setString, RawJdbcUtil::getString);
        add(list, "ic_material_quantity", ItemConstructionMaster::setIcMaterialQuantity, ItemConstructionMaster::getIcMaterialQuantity, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "ic_loss_ratio", ItemConstructionMaster::setIcLossRatio, ItemConstructionMaster::getIcLossRatio, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        COLUMN_LIST = list;
    }
