...
import com.example.nedo.db.raw.dao.RawJdbcColumn.PsSetter;
import com.example.nedo.db.raw.dao.RawJdbcColumn.RsGetter;
...
public abstract class RawJdbcDao<E> {
    ...
    protected static <E, V> void add(List<RawJdbcColumn<E, ?>> list, String name, BiConsumer<E, V> entitySetter, Function<E, V> entityGetter, PsSetter<V> psSetter, RsGetter<V> rsGetter) {
