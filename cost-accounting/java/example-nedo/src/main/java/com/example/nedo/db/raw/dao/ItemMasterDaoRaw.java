...
import static com.example.nedo.db.raw.dao.RawJdbcUtil.getInt;
import static com.example.nedo.db.raw.dao.RawJdbcUtil.setDate;
import static com.example.nedo.db.raw.dao.RawJdbcUtil.setInt;
import static com.example.nedo.db.raw.dao.RawJdbcUtil.setItemType;
...
public class ItemMasterDaoRaw extends RawJdbcDao<ItemMaster> implements ItemMasterDao {
    ...
    static {
        ...
        add(list, "i_effective_date", ItemMaster::setIEffectiveDate, ItemMaster::getIEffectiveDate, RawJdbcUtil::setDate, RawJdbcUtil::getDate, true);
        add(list, "i_expired_date", ItemMaster::setIExpiredDate, ItemMaster::getIExpiredDate, RawJdbcUtil::setDate, RawJdbcUtil::getDate);
        add(list, "i_name", ItemMaster::setIName, ItemMaster::getIName, RawJdbcUtil::setString, RawJdbcUtil::getString);
        add(list, "i_type", ItemMaster::setIType, ItemMaster::getIType, RawJdbcUtil::setItemType, RawJdbcUtil::getItemType);
        add(list, "i_unit", ItemMaster::setIUnit, ItemMaster::getIUnit, RawJdbcUtil::setString, RawJdbcUtil::getString);
        add(list, "i_weight_ratio", ItemMaster::setIWeightRatio, ItemMaster::getIWeightRatio, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "i_weight_unit", ItemMaster::setIWeightUnit, ItemMaster::getIWeightUnit, RawJdbcUtil::setString, RawJdbcUtil::getString);
        add(list, "i_price", ItemMaster::setIPrice, ItemMaster::getIPrice, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "i_price_unit", ItemMaster::setIPriceUnit, ItemMaster::getIPriceUnit, RawJdbcUtil::setString, RawJdbcUtil::getString);
        COLUMN_LIST = list;
    }
