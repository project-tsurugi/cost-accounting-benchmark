...
import static com.example.nedo.db.raw.dao.RawJdbcUtil.*;
...
import com.example.nedo.db.raw.CostBenchDbManagerJdbc;
...
public class ResultTableDaoRaw extends RawJdbcDao<ResultTable> implements ResultTableDao {
    ...
    static {
        ...
        add(list, "r_manufacturing_date", ResultTable::setRManufacturingDate, ResultTable::getRManufacturingDate, RawJdbcUtil::setDate, RawJdbcUtil::getDate, true);
        add(list, "r_product_i_id", ResultTable::setRProductIId, ResultTable::getRProductIId, RawJdbcUtil::setInt, RawJdbcUtil::getInt, true);
        add(list, "r_parent_i_id", ResultTable::setRParentIId, ResultTable::getRParentIId, RawJdbcUtil::setInt, RawJdbcUtil::getInt, true);
        add(list, "r_i_id", ResultTable::setRIId, ResultTable::getRIId, RawJdbcUtil::setInt, RawJdbcUtil::getInt, true);
        add(list, "r_manufacturing_quantity", ResultTable::setRManufacturingQuantity, ResultTable::getRManufacturingQuantity, RawJdbcUtil::setBigInt, RawJdbcUtil::getBigInt);
        add(list, "r_weight_unit", ResultTable::setRWeightUnit, ResultTable::getRWeightUnit, RawJdbcUtil::setString, RawJdbcUtil::getString);
        add(list, "r_weight", ResultTable::setRWeight, ResultTable::getRWeight, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "r_weight_total_unit", ResultTable::setRWeightTotalUnit, ResultTable::getRWeightTotalUnit, RawJdbcUtil::setString, RawJdbcUtil::getString);
        add(list, "r_weight_total", ResultTable::setRWeightTotal, ResultTable::getRWeightTotal, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "r_weight_ratio", ResultTable::setRWeightRatio, ResultTable::getRWeightRatio, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "r_standard_quantity_unit", ResultTable::setRStandardQuantityUnit, ResultTable::getRStandardQuantityUnit, RawJdbcUtil::setString, RawJdbcUtil::getString);
        add(list, "r_standard_quantity", ResultTable::setRStandardQuantity, ResultTable::getRStandardQuantity, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "r_required_quantity_unit", ResultTable::setRRequiredQuantityUnit, ResultTable::getRRequiredQuantityUnit, RawJdbcUtil::setString, RawJdbcUtil::getString);
        add(list, "r_required_quantity", ResultTable::setRRequiredQuantity, ResultTable::getRRequiredQuantity, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "r_unit_cost", ResultTable::setRUnitCost, ResultTable::getRUnitCost, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "r_total_unit_cost", ResultTable::setRTotalUnitCost, ResultTable::getRTotalUnitCost, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "r_manufacturing_cost", ResultTable::setRManufacturingCost, ResultTable::getRManufacturingCost, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "r_total_manufacturing_cost", ResultTable::setRTotalManufacturingCost, ResultTable::getRTotalManufacturingCost, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        COLUMN_LIST = list;
    }
