...
public class ItemManufacturingMasterDaoRaw extends RawJdbcDao<ItemManufacturingMaster>
		implements ItemManufacturingMasterDao {
	...
	static {
		...
		add(list, "im_manufacturing_quantity", ItemManufacturingMaster::setImManufacturingQuantity,
				ItemManufacturingMaster::getImManufacturingQuantity, RawJdbcUtil::setBigInt, RawJdbcUtil::getBigInt);
		COLUMN_LIST = list;
	}
