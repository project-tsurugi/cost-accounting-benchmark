...
public class MeasurementMasterDaoRaw extends RawJdbcDao<MeasurementMaster> implements MeasurementMasterDao {
	...
	static {
		...
		add(list, "m_type", MeasurementMaster::setMType, MeasurementMaster::getMType, RawJdbcUtil::setMeasurementType,
				RawJdbcUtil::getMeasurementType);
		add(list, "m_default_unit", MeasurementMaster::setMDefaultUnit, MeasurementMaster::getMDefaultUnit,
				RawJdbcUtil::setString, RawJdbcUtil::getString);
		add(list, "m_scale", MeasurementMaster::setMScale, MeasurementMaster::getMScale, RawJdbcUtil::setDecimal,
