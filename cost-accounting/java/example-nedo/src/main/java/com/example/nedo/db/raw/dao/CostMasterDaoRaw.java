...
public class CostMasterDaoRaw extends RawJdbcDao<CostMaster> implements CostMasterDao {
    ...
    static {
        ...
        add(list, "c_stock_unit", CostMaster::setCStockUnit, CostMaster::getCStockUnit, RawJdbcUtil::setString, RawJdbcUtil::getString);
        add(list, "c_stock_quantity", CostMaster::setCStockQuantity, CostMaster::getCStockQuantity, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        add(list, "c_stock_amount", CostMaster::setCStockAmount, CostMaster::getCStockAmount, RawJdbcUtil::setDecimal, RawJdbcUtil::getDecimal);
        COLUMN_LIST = list;
    }
