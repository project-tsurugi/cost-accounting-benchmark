...
//					System.out.println("shutdown-hook start");
    ...
    private static List<BenchOnlineThread> createThread(int threadSize, CostBenchDbManager manager, LocalDate batchDate, AtomicBoolean stopRequest) {
    ...
    private static void create1(CostBenchDbManager manager, List<BenchOnlineThread> threadList, List<Integer> factoryList, LocalDate date, AtomicBoolean stopRequest) {
